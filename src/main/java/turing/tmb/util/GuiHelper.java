...
public class GuiHelper implements IGuiHelper {
	...
	public void drawGuiIconDouble(double x, double y, double width, double height, IconCoordinate coordinate) {
		...
		Tessellator tessellator = Tessellator.instance;
		tessellator.startDrawingQuads();
		tessellator.addVertexWithUV(x + 0, y + height, 0, coordinate.getIconUMin(), coordinate.getIconVMax());
		tessellator.addVertexWithUV(x + width, y + height, 0, coordinate.getIconUMax(), coordinate.getIconVMax());
		tessellator.addVertexWithUV(x + width, y + 0, 0, coordinate.getIconUMax(), coordinate.getIconVMin());
		tessellator.addVertexWithUV(x + 0, y + 0, 0, coordinate.getIconUMin(), coordinate.getIconVMin());
		tessellator.draw();
	}
